...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/halain/booking', [bookingcontroller::class, 'index']);
    Route::get('/halain/booking', function () {
        return view('halain.booking.index');
    });

    Route::get('/halain/about', [aboutcontroller::class, 'index']);
    Route::get('/halain/about', function () {
