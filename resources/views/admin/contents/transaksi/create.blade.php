  ...
  <section class="section">
    <div class="card">
        <div class="card-body">
          ...
          <form action="/admin/transaksi/store" method="POST">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <input id="mulai" name="mulai" type="time" class="form-control" required="required">
              </div>
            </div>
            <div class="form-group row">
              <label for="akhir" class="col-4 col-form-label">Akhir</label> 
              <div class="col-8">
                <input id="akhir" name="akhir" type="time" class="form-control" required="required">
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <input id="biaya" name="biaya" type="text" class="form-control" required="required">
              </div>
            </div> 
            <div class="form-group row">
